...
export function getPopupDomRefs(document: Document): PopupDomRefs {
  return {
    ...
    statusDismissButton: getRequiredElement<HTMLButtonElement>(
      document,
      'btn-status-dismiss',
    ),
    summarySection: getRequiredElement<HTMLElement>(
      document,
      'summary-section',
    ),
    ...
    toBePerformedHoursValue: getRequiredElement<HTMLSpanElement>(
      document,
      'to-be-performed-hours-value',
    ),
    scrapeStatus: getRequiredElement<HTMLSpanElement>(
      document,
      'scrape-status',
    ),
    dataOriginIndicator: getRequiredElement<HTMLParagraphElement>(
      document,
      'data-origin-indicator',
    ),
    schedulesList: getRequiredElement<HTMLUListElement>(
      document,
      'schedules-list',
    ),
    schedulesEmpty: getRequiredElement<HTMLParagraphElement>(
      document,
      'schedules-empty',
    ),
    addScheduleButton: getRequiredElement<HTMLButtonElement>(
      document,
      'btn-add-schedule',
    ),
    applySchedulesButton: getRequiredElement<HTMLButtonElement>(
      document,
      'btn-apply-schedules',
    ),
    scheduleFormSection: getRequiredElement<HTMLElement>(
      document,
      'schedule-form-section',
    ),
    scheduleForm: getRequiredElement<HTMLFormElement>(
      document,
      'schedule-form',
    ),
    scheduleFormTitle: getRequiredElement<HTMLElement>(
      document,
      'schedule-form-title',
    ),
    scheduleLabelInput: getRequiredElement<HTMLInputElement>(
      document,
      'schedule-label',
    ),
    scheduleProjectSelect: getRequiredElement<HTMLSelectElement>(
      document,
      'schedule-project',
    ),
    scheduleFormCancel: getRequiredElement<HTMLButtonElement>(
      document,
    ...
    hoursInputs: {
      ...
      wednesday: getRequiredElement<HTMLInputElement>(
        document,
        'hours-wednesday',
      ),
      thursday: getRequiredElement<HTMLInputElement>(
        document,
        'hours-thursday',
      ),
      friday: getRequiredElement<HTMLInputElement>(document, 'hours-friday'),
      saturday: getRequiredElement<HTMLInputElement>(
        document,
        'hours-saturday',
      ),
