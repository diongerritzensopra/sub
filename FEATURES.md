...
#### Feature description
- [x] Determine whether popup-level integration tests (tests that exercise multiple popup modules wired together) are necessary after the *Popup unit test refactoring* is complete.
